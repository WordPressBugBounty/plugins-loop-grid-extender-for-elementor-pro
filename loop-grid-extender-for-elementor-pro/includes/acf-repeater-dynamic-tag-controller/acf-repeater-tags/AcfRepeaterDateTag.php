...
if (!class_exists('AcfRepeaterDateTag')) {

    class AcfRepeaterDateTag extends \Elementor\Core\DynamicTags\Tag {
        public function get_name() {
            return 'lgefep-acf-repeater-date';
        }

        public function get_title() {
            return 'ACF Repeater Date';
        }
        ...
        public function get_supported_fields() {
            return ['date_picker', 'date_time_picker'];
        }
        ...
        public function get_value( array $options = [] ) {
            ...
            if ( !in_array( $field_type, ['date_picker', 'date_time_picker'] ) ) {
                return '';
            }
            $result = '';
            if ( is_array( $value ) ) {
