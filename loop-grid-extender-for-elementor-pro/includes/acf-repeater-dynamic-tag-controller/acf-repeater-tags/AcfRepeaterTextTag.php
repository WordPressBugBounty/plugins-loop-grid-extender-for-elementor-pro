...
if (!class_exists('AcfRepeaterTextTag')) {
    
  
    class AcfRepeaterTextTag extends \Elementor\Core\DynamicTags\Tag {
        public function get_name() {
            return 'lgefep-acf-repeater-text';
        }
